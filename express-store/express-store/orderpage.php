...
<head>
  ...
  <title>Order Page - Express Store</title>
  ...
  <div class="container">
    <div class="row mt-5">
      <div class="col-sm-6 mx-auto">
        ...
        <h4 class="text-center">Order Confirmation and updates will be sent to<br>
          <?php
          if (isset($_SESSION['loggedin'])) {
        ...
        <div class="mt-4">
          <div class="d-flex justify-content-between">
            <span><b>
                ...
                echo "Order#" . generateRandomString();
                ?>
              </b></span>
            <span><a href="">Print Order</a></span>
          </div>
        </div>
        <div class="mt-2">
          <div class="d-flex justify-content-between">
            <span><?php echo date("M") . " " . date("d") . ", " . date("Y"); ?></span>
            <span><a href=""></a></span>
          </div>
        </div>
        <hr>
        <div class="mt-5">
          <div class="d-flex justify-content-center">
            <span><b>Payment Status: Payment Complete</b></span>
            <span><a href=""></a></span>
          </div>
        </div>
        <div class="mt-2">
          <div class="d-flex justify-content-center">
            <span>Paid through Credit Card</span>
            <span><a href=""></a></span>
          </div>
        </div>
        <div class="mt-2">
          <div class="d-flex justify-content-center">
            <span>Total $<?php $conn = mysqli_connect("localhost", "root", "", "express_store");
        ...
        <div class="mt-5">
          <div class="d-flex justify-content-center">
            <a href="./index.php" class="btn-send">Continue Shopping</a>
          </div>
        </div>
      </div>
    </div>
