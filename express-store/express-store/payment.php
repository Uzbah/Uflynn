...
<head>
  ...
  <title>Payment - Express Store</title>
              ...
              <div class="d-flex justify-content-center align=items-center mt-3">
                ...
                <form action="./payment2.php" method="post">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="mt-1">
                        <input type="text" name="cred" placeholder="Credit Card Number *" class="w-100" required>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <input type="number" name="expm" placeholder="Exp Month *" class="w-100" min=1 max=12 required>
                    </div>
                    <div class="col-sm-4">
                      <input type="number" name="expy" placeholder="Exp Year *" class="w-100" min=2022 required>
                    </div>
                    <div class="col-sm-4">
                      <input type="number" name="cvv" placeholder="CVV *" class="w-100" required>
                    </div>
