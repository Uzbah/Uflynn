...
<head>
  ...
  <title>Shipping - Express Store</title>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-12 mb-4">
              ...
              <form action="./shipping2.php" method="post">
                <div class="row mt-5">
                  <div class="col-sm-12">
                    <input type="text" name="country" placeholder="Country *" class="w-100" required>
                  </div>
                  <div class="col-sm-12">
                    <input type="text" name="street" placeholder="Street Address *" class="w-100" required>
                  </div>
                  <div class="col-sm-12">
                    <input type="text" name="apt" placeholder="Apt #, Floor etc. (Optional) *" class="w-100">
                  </div>
                  <div class="col-sm-4">
                    <input type="tel" name="postal" placeholder="Postal Code *" class="w-100" required>
                  </div>
                  <div class="col-sm-4">
