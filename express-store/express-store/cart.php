...
<head>
  ...
  <title>Cart - Express Store</title>
                ...
                echo '<tr>
                            <td>
                                <div class="cart-info">
                                    <img src="' . $row['image'] . '">
                                    <div>
                                        <p style="width:400px">' . $row['name'] . '</p>
                                        <small>Price: $' . $row['price'] . '</small><br>
                                        <small>Color: ' . $row['color'] . '</small><br>
                                        <small>W' . $row['waist'] . ' L' . $row['length'] . '</small><br>
                                        <a href="./removeitem.php?id=' . $row['order_id'] . '">Remove</a>
                                    </div>
                                </div>
                            </td>
                            <td><input type="number" value="1" min=1 disabled></td>
                            <td>$' . $row['price'] . '</td></tr>';
              }
            }
            ?>
